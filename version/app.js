...
app.get('/', function (req, res) {
    ...
    <body>
        <div class="container">
            ...
            <p>Upon completing the Cloud & DevOps Engineering course from SJCET, learners will achieve:</p>
            <ul>
            ...
            <div class="footer">
                <p>&copy; ${new Date().getFullYear()} SJCET | Cloud & DevOps Engineering</p>
            </div>
        </div>
    </body>
    </html>
